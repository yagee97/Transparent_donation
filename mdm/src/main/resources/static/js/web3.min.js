require = function t(e, n, r) {
    ...
    6: [function (t, e, n) {
        ...
        i.prototype = new o({}), i.prototype.constructor = i, i.prototype.isType = function (t) {
            ...
            var e = t.match(/^bytes([0-9]*)/), n = parseInt(e[1]);
            return n * this.staticArrayLength(t)
        }, e.exports = i
    }, {"./formatters": 9, "./type": 14}],
    7: [function (t, e, n) {
        var r = t("./formatters"), o = t("./address"), i = t("./bool"), a = t("./int"), s = t("./uint"),
            c = t("./dynamicbytes"), u = t("./string"), f = t("./real"), p = t("./ureal"), l = t("./bytes"),
            h = function (t) {
                this._types = t
            };
    ...
    14: [function (t, e, n) {
        ...
        i.prototype.isType = function (t) {
            ...
            if (this.isDynamicArray(n)) return function () {
                for (var o = parseInt("0x" + t.substr(2 * e, 64)), i = parseInt("0x" + t.substr(2 * o, 64)), a = o + 32, s = r.nestedName(n), c = r.staticPartLength(s), u = 32 * Math.floor((c + 31) / 32), f = [], p = 0; p < i * u; p += u) f.push(r.decode(t, a + p, s));
                return f
            }();
            ...
            if (this.isDynamicType(n)) return function () {
                var n = parseInt("0x" + t.substr(2 * e, 64)), i = parseInt("0x" + t.substr(2 * n, 64)),
    ...
    20: [function (t, e, n) {
        var r = t("bignumber.js"), o = t("./sha3.js"), i = t("utf8"), a = {
            ...
            return !!/^(0x)?[0-9a-f]{40}$/i.test(t) && (!(!/^(0x)?[0-9a-f]{40}$/.test(t) && !/^(0x)?[0-9A-F]{40}$/.test(t)) || A(t))
        }, A = function (t) {
            t = t.replace("0x", "");
    ...
    21: [function (t, e, n) {
        e.exports = {version: "0.17.0-alpha"}
    }, {}],
    22: [function (t, e, n) {
        function r(t) {
            this._requestManager = new o(t), this.currentProvider = t, this.eth = new a(this), this.db = new s(this), this.shh = new c(this), this.net = new u(this), this.personal = new f(this), this.settings = new p, this.version = {api: l.version}, this.providers = {
                HttpProvider: v,
                IpcProvider: b
            }, this._extend = m(this), this._extend({properties: w()})
        }
        ...
        var o = t("./web3/requestmanager"), i = t("./web3/iban"), a = t("./web3/methods/eth"),
            ...
            f = t("./web3/methods/personal"), p = t("./web3/settings"), l = t("./version.json"), h = t("./utils/utils"),
            d = t("./utils/sha3"), m = t("./web3/extend"), y = t("./web3/batch"), g = t("./web3/property"),
            v = t("./web3/httpprovider"), b = t("./web3/ipcprovider"), _ = t("bignumber.js");
        r.providers = {HttpProvider: v, IpcProvider: b}, r.prototype.setProvider = function (t) {
        ...
        var w = function () {
            return [new g({name: "version.node", getter: "web3_clientVersion"}), new g({
                ...
                inputFormatter: h.toDecimal
            }), new g({name: "version.whisper", getter: "shh_version", inputFormatter: h.toDecimal})]
        };
        ...
        var r = t("../utils/utils"), o = t("../solidity/coder"), i = t("./event"), a = t("./function"),
            s = t("./allevents"), c = function (t, e) {
                ...
                var n = 0, r = !1, o = t._eth.filter("latest", function (i) {
                    if (!i && !r) if (n++, n > 50) {
                        ...
                        i && !r && t._eth.getCode(i.contractAddress, function (n, a) {
                            if (!r && a) if (o.stopWatching(), r = !0, a.length > 3) t.address = i.contractAddress, u(t), f(t), e && e(null, t); else {
                ...
                this.eth = t, this.abi = e, this.new = function () {
                    var t, e = new h(this.eth, this.abi), n = {}, o = Array.prototype.slice.call(arguments);
    ...
    28: [function (t, e, n) {
        ...
        e.exports = s
    }, {"./../utils/utils": 20, "./formatters": 30, "./method": 36, "./property": 44}],
    29: [function (t, e, n) {
        var r = t("./formatters"), o = t("../utils/utils"), i = function (t) {
            ...
            }), this.requestManager = t, this.options = a(e), this.implementation = u, this.filterId = null, this.callbacks = [], this.getLogsCallbacks = [], this.pollFilters = [], this.formatter = r, this.implementation.newFilter(this.options, function (t, e) {
    ...
    31: [function (t, e, n) {
        var r = t("../solidity/coder"), o = t("../utils/utils"), i = t("./formatters"), a = t("../utils/sha3"),
            s = function (t, e, n) {
        ...
        s.prototype.extractCallback = function (t) {
            ...
            if (t.length > this._inputTypes.length && !o.isObject(t[t.length - 1])) return i.inputDefaultBlockNumberFormatter(t.pop())
    ...
    }, {"../solidity/coder": 7, "../utils/sha3": 19, "../utils/utils": 20, "./formatters": 30}],
    32: [function (t, e, n) {
        "use strict";
        var r, o = t("./errors"), i = t("xhr2");
        ...
        a.prototype.prepareRequest = function (t) {
            var e;
            return t ? (e = new i, e.timeout = this.timeout) : e = new r, e.open("POST", this.host, t), e.setRequestHeader("Content-Type", "application/json"), e
    ...
    38: [function (t, e, n) {
        ...
        var o = t("../formatters"), i = t("../../utils/utils"), a = t("../method"), s = t("../property"),
            c = t("../../utils/config"), u = t("../contract"), f = t("./watches"), p = t("../filter"),
            l = t("../syncing"), h = t("../namereg"), d = t("../iban"), m = t("../transfer"), y = function (t) {
        ...
        var w = function () {
            var t = new a({
                ...
                }), x = new a({name: "sign", call: "eth_sign", params: 2, inputFormatter: [o.inputAddressFormatter, null]}),
                k = new a({
                    name: "call",
                    call: "eth_call",
                    params: 2,
                    ...
                    outputFormatter: i.toDecimal
                }), S = new a({name: "compile.solidity", call: "eth_compileSolidity", params: 1}),
                A = new a({name: "compile.lll", call: "eth_compileLLL", params: 1}),
                C = new a({name: "compile.serpent", call: "eth_compileSerpent", params: 1}),
                F = new a({name: "submitWork", call: "eth_submitWork", params: 3}),
                I = new a({name: "getWork", call: "eth_getWork", params: 0});
    ...
    40: [function (t, e, n) {
        ...
        e.exports = r
    }, {"../formatters": 30, "../method": 36, "../property": 44}],
    41: [function (t, e, n) {
        ...
        e.exports = s
    }, {"../filter": 29, "../formatters": 30, "../method": 36, "./watches": 42}],
    42: [function (t, e, n) {
        ...
        !function (r, o, i) {
            ...
            return function () {
                ...
                var m = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], y = o.AES = r.extend({
                    _doReset: function () {
                        for (var t = this._key, e = t.words, n = t.sigBytes / 4, r = this._nRounds = n + 6, o = 4 * (r + 1), a = this._keySchedule = [], s = 0; s < o; s++) if (s < n) a[s] = e[s]; else {
                            var c = a[s - 1];
                        ...
                        for (var u = this._invKeySchedule = [], f = 0; f < o; f++) {
                            ...
                            f < 4 || s <= 4 ? u[f] = c : u[f] = p[i[c >>> 24]] ^ l[i[c >>> 16 & 255]] ^ h[i[c >>> 8 & 255]] ^ d[i[255 & c]]
                        }
                        ...
                        for (var c = this._nRounds, u = t[e] ^ n[0], f = t[e + 1] ^ n[1], p = t[e + 2] ^ n[2], l = t[e + 3] ^ n[3], h = 4, d = 1; d < c; d++) {
        ...
        !function (r, o) {
            ...
            t.lib.Cipher || function (e) {
                var n = t, r = n.lib, o = r.Base, i = r.WordArray, a = r.BufferedBlockAlgorithm, s = n.enc,
                    c = (s.Utf8, s.Base64), u = n.algo, f = u.EvpKDF, p = r.Cipher = a.extend({
                        ...
                        cfg: p.cfg.extend({mode: d, padding: y}), reset: function () {
                            p.reset.call(this);
            ...
            var t = t || function (t, e) {
                var n = {}, r = n.lib = {}, o = r.Base = function () {
                    ...
                    reset: function () {
                        ...
                        var n = this._data, r = n.words, o = n.sigBytes, a = this.blockSize, s = 4 * a, c = o / s;
                        c = e ? t.ceil(c) : t.max((0 | c) - this._minBufferSize, 0);
                        var u = c * a, f = t.min(4 * u, o);
                        if (u) {
                            for (var p = 0; p < u; p += a) this._doProcessBlock(r, p);
                            var l = r.splice(0, u);
                            n.sigBytes -= f
                        }
            ...
            return function () {
                ...
                o.Base64 = {
                    stringify: function (t) {
                        ...
                        var p = r.charAt(64);
                        if (p) for (; o.length % 4;) o.push(p);
                        return o.join("")
                    }, parse: function (t) {
                        var e = t.length, n = this._map, o = n.charAt(64);
                        if (o) {
                            var i = t.indexOf(o);
                            i != -1 && (e = i)
                        }
                        for (var a = [], s = 0, c = 0; c < e; c++) if (c % 4) {
                            var u = n.indexOf(t.charAt(c - 1)) << c % 4 * 2,
                                f = n.indexOf(t.charAt(c)) >>> 6 - c % 4 * 2, p = u | f;
                            a[s >>> 2] |= p << 24 - s % 4 * 8, s++
                        }
                        return r.create(a, s)
    ...
    60: [function (t, e, n) {
        !function (r, o) {
            ...
            return function (e) {
                ...
                var a = t, s = a.lib, c = s.WordArray, u = s.Hasher, f = a.algo, p = [];
                !function () {
                ...
                var l = f.MD5 = u.extend({
                    _doReset: function () {
                        ...
                        var u = this._hash.words, f = t[e + 0], l = t[e + 1], h = t[e + 2], d = t[e + 3], m = t[e + 4],
                    ...
                    c = i.PBKDF2 = r.extend({
                        cfg: r.extend({keySize: 4, hasher: a, iterations: 1}), init: function (t) {
                            ...
                            for (var n = this.cfg, r = s.create(n.hasher, t), i = o.create(), a = o.create([1]), c = i.words, u = a.words, f = n.keySize, p = n.iterations; c.length < f;) {
                                ...
                                r.reset();
                                for (var h = l.words, d = h.length, m = l, y = 1; y < p; y++) {
                        ...
                        _doReset: function () {
                            ...
                            if (n) {
                                var a = n.words, s = a[0], c = a[1],
                                    ...
                                    p = u >>> 16 | 4294901760 & f, l = f << 16 | 65535 & u;
    ...
    75: [function (t, e, n) {
        !function (r, o) {
            ...
            return function (e) {
                ...
                var c = t, u = c.lib, f = u.WordArray, p = u.Hasher, l = c.algo,
                    ...
                    v = f.create([1352829926, 1548603684, 1836072691, 2053994217, 0]), b = l.RIPEMD160 = p.extend({
                        _doReset: function () {
                            ...
                            var p, l, b, _, w, x, k, B, S, A, C = this._hash.words, F = g.words, I = v.words, O = h.words,
                                N = d.words, D = m.words, T = y.words;
                            x = p = C[0], k = l = C[1], B = b = C[2], S = _ = C[3], A = w = C[4];
                            for (var P, c = 0; c < 80; c += 1) P = p + t[e + O[c]] | 0, P += c < 16 ? n(l, b, _) + F[0] : c < 32 ? r(l, b, _) + F[1] : c < 48 ? o(l, b, _) + F[2] : c < 64 ? i(l, b, _) + F[3] : a(l, b, _) + F[4], P = 0 | P, P = s(P, D[c]), P = P + w | 0, p = w, w = _, _ = s(b, 10), b = l, l = P, P = x + t[e + N[c]] | 0, P += c < 16 ? a(k, B, S) + I[0] : c < 32 ? i(k, B, S) + I[1] : c < 48 ? o(k, B, S) + I[2] : c < 64 ? r(k, B, S) + I[3] : n(k, B, S) + I[4], P = 0 | P, P = s(P, T[c]), P = P + A | 0, x = A, A = S, S = s(B, 10), B = k, k = P;
                ...
                var e = t, n = e.lib, r = n.WordArray, o = n.Hasher, i = e.algo, a = [], s = i.SHA1 = o.extend({
                    _doReset: function () {
                        ...
                        for (var n = this._hash.words, r = n[0], o = n[1], i = n[2], s = n[3], c = n[4], u = 0; u < 80; u++) {
                            ...
                            p += u < 20 ? (o & i | ~o & s) + 1518500249 : u < 40 ? (o ^ i ^ s) + 1859775393 : u < 60 ? (o & i | o & s | i & s) - 1894007588 : (o ^ i ^ s) - 899497514, c = s, s = i, i = o << 30 | o >>> 2, o = r, r = p
                        }
                ...
                var h = c.SHA3 = i.extend({
                    cfg: i.cfg.extend({outputLength: 512}), _doReset: function () {
                        ...
                        for (var c = 0; c < 24; c++) {
                            ...
                            for (var h = 0; h < 5; h++) for (var v = l[(h + 4) % 5], b = l[(h + 1) % 5], _ = b.high, w = b.low, d = v.high ^ (_ << 1 | w >>> 31), m = v.low ^ (w << 1 | _ >>> 31), y = 0; y < 5; y++) {
                                var s = n[h + 5 * y];
                                s.high ^= d, s.low ^= m
                            }
                            for (var x = 1; x < 25; x++) {
                            ...
                            for (var h = 0; h < 5; h++) for (var y = 0; y < 5; y++) {
                                var x = h + 5 * y, s = n[x], I = l[x], O = l[(h + 1) % 5 + 5 * y],
                                    N = l[(h + 2) % 5 + 5 * y];
            ...
            return function () {
                ...
                var p = c.SHA512 = o.extend({
                    _doReset: function () {
                        ...
                        for (var n = this._hash.words, r = n[0], o = n[1], i = n[2], a = n[3], s = n[4], c = n[5], p = n[6], l = n[7], h = r.high, d = r.low, m = o.high, y = o.low, g = i.high, v = i.low, b = a.high, _ = a.low, w = s.high, x = s.low, k = c.high, B = c.low, S = p.high, A = p.low, C = l.high, F = l.low, I = h, O = d, N = m, D = y, T = g, P = v, E = b, R = _, M = w, H = x, j = k, q = B, L = S, z = A, U = C, W = F, J = 0; J < 80; J++) {
                            var G = f[J];
                            if (J < 16) var X = G.high = 0 | t[e + 2 * J], $ = G.low = 0 | t[e + 2 * J + 1]; else {
                                var V = f[J - 15], K = V.high, Z = V.low,
                                    ...
                                    $ = Q + st, X = Y + at + ($ >>> 0 < Q >>> 0 ? 1 : 0), $ = $ + ot,
                                    X = X + rt + ($ >>> 0 < ot >>> 0 ? 1 : 0), $ = $ + ft,
                                    X = X + ut + ($ >>> 0 < ft >>> 0 ? 1 : 0);
                                G.high = X, G.low = $
                            }
                            var pt = M & j ^ ~M & L, lt = H & q ^ ~H & z, ht = I & N ^ I & T ^ N & T,
                                dt = O & D ^ O & P ^ D & P,
                                ...
                                xt = xt + lt, kt = kt + pt + (xt >>> 0 < lt >>> 0 ? 1 : 0), xt = xt + wt,
                                kt = kt + _t + (xt >>> 0 < wt >>> 0 ? 1 : 0), xt = xt + $,
                                kt = kt + X + (xt >>> 0 < $ >>> 0 ? 1 : 0), Bt = yt + dt,
                                St = mt + ht + (Bt >>> 0 < yt >>> 0 ? 1 : 0);
                            U = L, W = z, L = j, z = q, j = M, q = H, H = R + xt | 0, M = E + kt + (H >>> 0 < R >>> 0 ? 1 : 0) | 0, E = T, R = P, T = N, P = D, N = I, D = O, O = xt + Bt | 0, I = kt + St + (O >>> 0 < xt >>> 0 ? 1 : 0) | 0
                        }
                        d = r.low = d + O, r.high = h + I + (d >>> 0 < O >>> 0 ? 1 : 0), y = o.low = y + D, o.high = m + N + (y >>> 0 < D >>> 0 ? 1 : 0), v = i.low = v + P, i.high = g + T + (v >>> 0 < P >>> 0 ? 1 : 0), _ = a.low = _ + R, a.high = b + E + (_ >>> 0 < R >>> 0 ? 1 : 0), x = s.low = x + H, s.high = w + M + (x >>> 0 < H >>> 0 ? 1 : 0), B = c.low = B + q, c.high = k + j + (B >>> 0 < q >>> 0 ? 1 : 0), A = p.low = A + z, p.high = S + L + (A >>> 0 < z >>> 0 ? 1 : 0), F = l.low = F + W, l.high = C + U + (F >>> 0 < W >>> 0 ? 1 : 0)
                    }, _doFinalize: function () {
                        var t = this._data, e = t.words, n = 8 * this._nDataBytes, r = 8 * t.sigBytes;
        ...
        !function (r, o, i) {
            ...
            return function () {
                ...
                var r = t, o = r.lib, i = o.WordArray, a = o.BlockCipher, s = r.algo,
                    ...
                    f = [1, 2, 4, 6, 8, 10, 12, 14, 15, 17, 19, 21, 23, 25, 27, 28], p = [{
                        0: 8421888,
                        268435456: 32768,
                        536870912: 8421378,
                        805306368: 2,
                    ...
                    h = s.DES = a.extend({
                        _doReset: function () {
                            ...
                            for (var i = this._subKeys = [], a = 0; a < 16; a++) {
                                for (var s = i[a] = [], p = f[a], r = 0; r < 24; r++) s[r / 6 | 0] |= n[(u[r] - 1 + p) % 28] << 31 - r % 6, s[4 + (r / 6 | 0)] |= n[28 + (u[r + 24] - 1 + p) % 28] << 31 - r % 6;
                                s[0] = s[0] << 1 | s[0] >>> 31;
                            ...
                            for (var i = 0; i < 16; i++) {
                                for (var a = o[i], s = this._lBlock, c = this._rBlock, u = 0, f = 0; f < 8; f++) u |= p[f][((c ^ a[f]) & l[f]) >>> 0];
    ...
    84: [function (t, e, n) {
        !function (t) {
            ...
            var l = "object" == typeof n && n, h = "object" == typeof e && e && e.exports == l && e,
                d = "object" == typeof global && global;
            d.global !== d && d.window !== d || (t = d);
            var m, y, g, v = String.fromCharCode, b = {version: "2.1.2", encode: c, decode: p};
            if ("function" == typeof define && "object" == typeof define.amd && define.amd) define(function () {
                return b
            }); else if (l && !l.nodeType) if (h) h.exports = b; else {
    ...
    "bignumber.js": [function (t, e, n) {
        !function (n) {
            ...
            function r(t) {
                function e(t, r) {
                    ...
                    if (null != r && J(r, 2, 64, E, "base")) {
                        ...
                        if ((s = "number" == typeof t) && 0 * t != 0 || !new RegExp("^-?" + (o = "[" + x.slice(0, r) + "]+") + "(?:\\." + o + ")?$", r < 37 ? "i" : "").test(u)) return m(f, u, s, r);
                        s ? (f.s = 1 / t < 0 ? (u = u.slice(1), -1) : 1, W && u.replace(/^0\.0*|\./, "").length > 15 && D(E, w, t), s = !1) : f.s = 45 === u.charCodeAt(0) ? (u = u.slice(1), -1) : 1, u = n(u, 10, r, f.s)
                    } else {
                    ...
                    for ((i = u.indexOf(".")) > -1 && (u = u.replace(".", "")), (a = u.search(/e/i)) > 0 ? (i < 0 && (i = a), i += +u.slice(a + 1), u = u.substring(0, a)) : i < 0 && (i = u.length), a = 0; 48 === u.charCodeAt(a); a++) ;
                    for (c = u.length; 48 === u.charCodeAt(--c);) ;
                    if (u = u.slice(a, c + 1)) if (c = u.length, s && W && c > 15 && D(E, w, f.s * t), i = i - a - 1, i > U) f.c = f.e = null; else if (i < z) f.c = [f.e = 0]; else {
                        if (f.e = i, f.c = [], a = (i + 1) % B, i < 0 && (a += B), a < c) {
                            for (a && f.c.push(+u.slice(0, a)), c -= B; a < c;) f.c.push(+u.slice(a, a += B));
                ...
                function n(t, n, r, o) {
                    var a, s, c, f, l, h, d, m = t.indexOf("."), y = H, g = j;
                    for (r < 37 && (t = t.toLowerCase()), m >= 0 && (c = $, $ = 0, t = t.replace(".", ""), d = new e(r), l = d.pow(t.length - m), $ = c, d.c = u(p(i(l.c), l.e), 10, n), d.e = d.c.length), h = u(t, r, n), s = c = h.length; 0 == h[--c]; h.pop()) ;
                    if (!h[0]) return "0";
                    if (m < 0 ? --s : (l.c = h, l.e = s, l.s = o, l = P(l, d, y, g, n), h = l.c, f = l.r, s = l.e), a = s + y + 1, m = h[a], c = n / 2, f = f || a < 0 || null != h[a + 1], f = g < 4 ? (null != m || f) && (0 == g || g == (l.s < 0 ? 3 : 2)) : m > c || m == c && (4 == g || f || 6 == g && 1 & h[a - 1] || g == (l.s < 0 ? 8 : 7)), a < 1 || !h[0]) t = f ? p("1", -y) : "0"; else {
                        if (h.length = a, f) for (--n; ++h[--a] > n;) h[a] = 0, a || (++s, h.unshift(1));
                        for (c = h.length; !h[--c];) ;
                        for (m = 0, t = ""; m <= c; t += x.charAt(h[m++])) ;
                        t = p(t, s)
                    }
                    return t
                }
                ...
                function h(t, n, r, o) {
                    ...
                    if (a = t.c[0], c = t.e, null == n) l = i(t.c), l = 19 == o || 24 == o && c <= q ? f(l, c) : p(l, c); else if (t = T(new e(t), n, r), s = t.e, l = i(t.c), u = l.length, 19 == o || 24 == o && (n <= s || s <= q)) {
                        for (; u < n; l += "0", u++) ;
                        l = f(l, s)
                    } else if (n -= c, l = p(l, s), s + 1 > u) {
                        if (--n > 0) for (l += "."; n--; l += "0") ;
                    } else if (n += s - u, n > 0) for (s + 1 == u && (l += "."); n--; l += "0") ;
                    return t.s < 0 && a ? "-" + l : l
                }
                ...
                function O(t, e, n, r, o) {
                    return (t < e || t > n || t != l(t)) && D(r, (o || "decimal places") + (t < e || t > n ? " out of range" : " not an integer"), t), !0
                }

                function N(t, e, n) {
                    for (var r = 1, o = e.length; !e[--o]; e.pop()) ;
                    for (o = e[0]; o >= 10; o /= 10, r++) ;
                    return (n = r + n * B - 1) > U ? t.c = t.e = null : n < z ? t.c = [t.e = 0] : (t.e = n, t.c = e), t
                }
                ...
                function T(t, e, n, r) {
                    var o, i, a, s, c, u, f, p = t.c, l = A;
                    if (p) {
                        t:{
                            for (o = 1, s = p[0]; s >= 10; s /= 10, o++) ;
                            if (i = e - o, i < 0) i += B, a = e, c = p[u = 0], f = c / l[o - a - 1] % 10 | 0; else if (u = g((i + 1) / B), u >= p.length) {
                                if (!r) break t;
                                for (; p.length <= u; p.push(0)) ;
                                c = f = 0, o = 1, i %= B, a = i - B + 1
                            } else {
                                for (c = s = p[u], o = 1; s >= 10; s /= 10, o++) ;
                                i %= B, a = i - B + o, f = a < 0 ? 0 : c / l[o - a - 1] % 10 | 0
                            }
                            if (r = r || e < 0 || null != p[u + 1] || (a < 0 ? c : c % l[o - a - 1]), r = n < 4 ? (f || r) && (0 == n || n == (t.s < 0 ? 3 : 2)) : f > 5 || 5 == f && (4 == n || r || 6 == n && (i > 0 ? a > 0 ? c / l[o - a] : 0 : p[u - 1]) % 10 & 1 || n == (t.s < 0 ? 8 : 7)), e < 1 || !p[0]) return p.length = 0, r ? (e -= t.e + 1, p[0] = l[e % B], t.e = -e || 0) : p[0] = t.e = 0, t;
                            if (0 == i ? (p.length = u, s = 1, u--) : (p.length = u + 1, s = l[B - i], p[u] = a > 0 ? v(c / l[o - a] % l[a]) * s : 0), r) for (; ;) {
                                if (0 == u) {
                ...
                var P, E = 0, R = e.prototype, M = new e(1), H = 20, j = 4, q = -7, L = 21, z = -1e7, U = 1e7, W = !0,
                    J = O, G = !1, X = 1, $ = 100, V = {
                        decimalSeparator: ".",
                        groupSeparator: ",",
                        groupSize: 3,
                ...
                return e.another = r, e.ROUND_UP = 0, e.ROUND_DOWN = 1, e.ROUND_CEIL = 2, e.ROUND_FLOOR = 3, e.ROUND_HALF_UP = 4, e.ROUND_HALF_DOWN = 5, e.ROUND_HALF_EVEN = 6, e.ROUND_HALF_CEIL = 7, e.ROUND_HALF_FLOOR = 8, e.EUCLID = 9, e.config = function () {
                    var t, e, n = 0, r = {}, o = arguments, i = o[0], a = i && "object" == typeof i ? function () {
                        if (i.hasOwnProperty(e)) return null != (t = i[e])
                    } : function () {
                        if (o.length > n) return null != (t = o[n++])
                    };
                    return a(e = "DECIMAL_PLACES") && J(t, 0, F, 2, e) && (H = 0 | t), r[e] = H, a(e = "ROUNDING_MODE") && J(t, 0, 8, 2, e) && (j = 0 | t), r[e] = j, a(e = "EXPONENTIAL_AT") && (c(t) ? J(t[0], -F, 0, 2, e) && J(t[1], 0, F, 2, e) && (q = 0 | t[0], L = 0 | t[1]) : J(t, -F, F, 2, e) && (q = -(L = 0 | (t < 0 ? -t : t)))), r[e] = [q, L], a(e = "RANGE") && (c(t) ? J(t[0], -F, -1, 2, e) && J(t[1], 1, F, 2, e) && (z = 0 | t[0], U = 0 | t[1]) : J(t, -F, F, 2, e) && (0 | t ? z = -(U = 0 | (t < 0 ? -t : t)) : W && D(2, e + " cannot be zero", t))), r[e] = [z, U], a(e = "ERRORS") && (t === !!t || 1 === t || 0 === t ? (E = 0, J = (W = !!t) ? O : s) : W && D(2, e + b, t)), r[e] = W, a(e = "CRYPTO") && (t === !!t || 1 === t || 0 === t ? (G = !(!t || !d || "object" != typeof d), t && !G && W && D(2, "crypto unavailable", d)) : W && D(2, e + b, t)), r[e] = G, a(e = "MODULO_MODE") && J(t, 0, 9, 2, e) && (X = 0 | t), r[e] = X, a(e = "POW_PRECISION") && J(t, 0, F, 2, e) && ($ = 0 | t), r[e] = $, a(e = "FORMAT") && ("object" == typeof t ? V = t : W && D(2, e + " not an object", t)), r[e] = V, r
                }, e.max = function () {
                    ...
                    return function (t) {
                        var r, o, i, a, s, c = 0, u = [], f = new e(M);
                        if (t = null != t && J(t, 0, F, 14) ? 0 | t : H, a = g(t / B), G) if (d && d.getRandomValues) {
                            for (r = d.getRandomValues(new Uint32Array(a *= 2)); c < a;) s = 131072 * r[c] + (r[c + 1] >>> 11), s >= 9e15 ? (o = d.getRandomValues(new Uint32Array(2)), r[c] = o[0], r[c + 1] = o[1]) : (u.push(s % 1e14), c += 2);
                            c = a / 2
                        } else if (d && d.randomBytes) {
                            for (r = d.randomBytes(a *= 7); c < a;) s = 281474976710656 * (31 & r[c]) + 1099511627776 * r[c + 1] + 4294967296 * r[c + 2] + 16777216 * r[c + 3] + (r[c + 4] << 16) + (r[c + 5] << 8) + r[c + 6], s >= 9e15 ? d.randomBytes(7).copy(r, c) : (u.push(s % 1e14), c += 7);
                            c = a / 7
                        } else W && D(14, "crypto unavailable", d);
                        if (!c) for (; c < a;) s = n(), s < 9e15 && (u[c++] = s % 1e14);
                    ...
                    function t(t, e, n) {
                        var r, o, i, a, s = 0, c = t.length, u = e % C, f = e / C | 0;
                    ...
                    return function (i, a, s, c, u) {
                        var f, p, l, h, d, m, y, g, b, _, w, x, S, A, C, F, I, O = i.s == a.s ? 1 : -1, N = i.c,
                            D = a.c;
                        ...
                        if (D[l] > (N[l] || 0) && p--, O < 0) b.push(1),
                            h = !0; else {
                            for (A = N.length, F = D.length, l = 0, O += 2, d = v(u / (D[0] + 1)), d > 1 && (D = t(D, d, u), N = t(N, d, u), F = D.length, A = N.length), S = F, _ = N.slice(0, F), w = _.length; w < F; _[w++] = 0) ;
                            I = D.slice(), I.unshift(0), C = D[0], D[1] >= u / 2 && C++;
                            do {
                                if (d = 0, f = n(D, _, F, w), f < 0) {
                                    if (x = _[0], F != w && (x = x * u + (_[1] || 0)), d = v(x / C), d > 1) for (d >= u && (d = u - 1), m = t(D, d, u), y = m.length, w = _.length; 1 == n(m, _, y, w);) d--, r(m, F < y ? I : D, y, u), y = m.length, f = 1; else 0 == d && (f = d = 1), m = D.slice(), y = m.length;
                                    if (y < w && m.unshift(0), r(_, m, w, u), w = _.length, f == -1) for (; n(D, _, F, w) < 1;) d++, r(_, F < w ? I : D, w, u), w = _.length
                                } else 0 === f && (d++, _ = [0]);
                    ...
                    var t = /^(-?)0([xbo])/i, n = /^([^.]+)\.$/, r = /^\.([^.]+)$/, o = /^-?(Infinity|NaN)$/,
                        i = /^\s*\+|^\s+|\s+$/g;
                    return function (a, s, c, u) {
                        var f, p = c ? s : s.replace(i, "");
                        if (o.test(p)) a.s = isNaN(p) ? null : p < 0 ? -1 : 1; else {
                    ...
                    var t, e, n = this.c;
                    if (!n) return null;
                    if (t = ((e = n.length - 1) - o(this.e / B)) * B, e = n[e]) for (; e % 10 == 0; e /= 10, t--) ;
                    return t < 0 && (t = 0), t
                    ...
                    return E = 9, (n = a(this, new e(t, n))) === -1 || 0 === n
                }, R.minus = R.sub = function (t, n) {
                    var r, i, a, s, c = this, u = c.s;
                    if (E = 10, t = new e(t, n), n = t.s, !u || !n) return new e(NaN);
                    if (u != n) return t.s = -n, c.plus(t);
                    var f = c.e / B, p = t.e / B, l = c.c, h = t.c;
                    if (!f || !p) {
                        if (!l || !h) return l ? (t.s = -n, t) : new e(h ? c : NaN);
                        if (!l[0] || !h[0]) return h[0] ? (t.s = -n, t) : new e(l[0] ? c : 3 == j ? -0 : 0)
                    }
                    if (f = o(f), p = o(p), l = l.slice(), u = f - p) {
                        for ((s = u < 0) ? (u = -u, a = l) : (p = f, a = h), a.reverse(), n = u; n--; a.push(0)) ;
                        a.reverse()
                    } else for (i = (s = (u = l.length) < (n = h.length)) ? u : n, u = n = 0; n < i; n++) if (l[n] != h[n]) {
                        s = l[n] < h[n];
                        break
                    }
                    if (s && (a = l, l = h, h = a, t.s = -t.s), n = (i = h.length) - (r = l.length), n > 0) for (; n--; l[r++] = 0) ;
                    for (n = k - 1; i > u;) {
                        if (l[--i] < h[i]) {
                            for (r = i; r && !l[--r]; l[r] = n) ;
                            --l[r], l[i] += k
                    ...
                    var s = i.e / B, c = t.e / B, u = i.c, f = t.c;
                    if (!s || !c) {
                    ...
                    for (a = u.length, n = f.length, a - n < 0 && (r = f, f = u, u = r, n = a), a = 0; n;) a = (u[--n] = u[n] + f[n] + a) / k | 0, u[n] %= k;
                    ...
                    var n = this;
                    return J(t, -S, S, 16, "argument") ? n.times("1e" + l(t)) : new e(n.c && n.c[0] && (t < -S || t > S) ? n.s * (t < 0 ? 0 : 1 / 0) : n)
                }, R.squareRoot = R.sqrt = function () {
                    var t, n, r, a, s, c = this, u = c.c, f = c.s, p = c.e, l = H + 4, h = new e("0.5");
                    if (1 !== f || !u || !u[0]) return new e(!f || f < 0 && (!u || u[0]) ? NaN : u ? c : 1 / 0);
                    if (f = Math.sqrt(+c), 0 == f || f == 1 / 0 ? (n = i(u), (n.length + p) % 2 == 0 && (n += "0"), f = Math.sqrt(n), p = o((p + 1) / 2) - (p < 0 || p % 2), f == 1 / 0 ? n = "1e" + p : (n = f.toExponential(), n = n.slice(0, n.indexOf("e") + 1) + p), r = new e(n)) : r = new e(f + ""), r.c[0]) for (p = r.e, f = p + l, f < 3 && (f = 0); ;) if (s = r, r = h.times(s.plus(P(c, s, l, 1))), i(s.c).slice(0, f) === (n = i(r.c)).slice(0, f)) {
                    ...
                    var r, i, a, s, c, u, f, p, l, h, d, m, y, g, v, b = this, _ = b.c, w = (E = 17, t = new e(t, n)).c;
                    if (!(_ && w && _[0] && w[0])) return !b.s || !t.s || _ && !_[0] && !w || w && !w[0] && !_ ? t.c = t.e = t.s = null : (t.s *= b.s, _ && w ? (t.c = [0], t.e = 0) : t.c = t.e = null), t;
                    for (i = o(b.e / B) + o(t.e / B), t.s *= b.s, f = _.length, h = w.length, f < h && (y = _, _ = w, w = y, a = f, f = h, h = a), a = f + h, y = []; a--; y.push(0)) ;
                    for (g = k, v = C, a = h; --a >= 0;) {
                    ...
                    if (this.c) {
                        var r, o = n.split("."), i = +V.groupSize, a = +V.secondaryGroupSize, s = V.groupSeparator,
                            c = o[0], u = o[1], f = this.s < 0, p = f ? c.slice(1) : c, l = p.length;
                        if (a && (r = i, i = a, a = r, l -= r), i > 0 && l > 0) {
                            for (r = l % i || i, c = p.substr(0, r); r < l; r += i) c += s + p.substr(r, i);
                            a > 0 && (c += s + p.slice(r)), f && (c = "-" + c)
                        }
                        n = u ? c + V.decimalSeparator + ((a = +V.fractionGroupSize) ? u.replace(new RegExp("\\d{" + a + "}\\B", "g"), "$&" + V.fractionGroupSeparator) : u) : c
                    }
                    return n
                }, R.toFraction = function (t) {
                    var n, r, o, a, s, c, u, f, p, l = W, h = this, d = h.c, m = new e(M), y = r = new e(M),
                        g = u = new e(M);
                    ...
                    return t < 0 && (r = M.div(r)), n ? T(r, $, j) : r
                }, R.toPrecision = function (t, e) {
                    return h(this, null != t && J(t, 1, F, 24, "precision") ? 0 | t : null, e, 24)
                }, R.toString = function (t) {
                    var e, r = this, o = r.s, a = r.e;
                    return null === a ? o ? (e = "Infinity", o < 0 && (e = "-" + e)) : e = "NaN" : (e = i(r.c), e = null != t && J(t, 2, 64, 25, "base") ? n(p(e, a), 0 | t, 10, o) : a <= q || a >= L ? f(e, a) : p(e, a), o < 0 && r.c[0] && (e = "-" + e)), e
            ...
            function l(t) {
                return t = parseFloat(t), t < 0 ? g(t) : v(t)
            }

            var h, d, m, y = /^-?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, g = Math.ceil, v = Math.floor,
                b = " not a boolean or binary digit", _ = "rounding mode",
                w = "number type has more than 15 significant digits",
                x = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ$_", k = 1e14, B = 14,
                S = 9007199254740991, A = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13],
                C = 1e7, F = 1e9;
